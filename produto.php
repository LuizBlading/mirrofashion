...
<?php 
    ...
    $estilos_css = '<link rel="stylesheet" href="css/produto.css">';
    include("cabecalho.php"); 
?>

<!-- Aqui vem o miolo da pagina depois! -->
<div class="produto-back">
    <div class="container">
        <div class="produto">
            ...
            <form action="checkout.php" method="POST"> <!-- Envia as informações para a pagina pelo
        metodo POST. Ficando escondido da URL -->
                <fieldset class="cores">
                    ...
                    <input type="radio" name="cor" value="Azul" id="azul">
                        <label for="azul">
                            <img src="img/produtos/foto2-azul.png" id="azul">
                        </label>
